...
use actix_web::dev::{AsyncResult, Handler, Resource, ResourceDef};
    ...
    S: 'static,
{
    ...
    pub fn new(manager: Addr<SM>) -> Self {
        ...
        let patterns: Vec<Resource> = PATTERNS
            .iter()
            .map(|s| Resource::new(ResourceDef::new(s)))
            .collect();
        // let _ = Resource::with_prefix("t");
